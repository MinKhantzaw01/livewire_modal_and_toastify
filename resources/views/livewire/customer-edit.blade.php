        ...
        <x-slot name="content">
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-12">
                    ...
                    <x-input id="form.name" wire:model="form.name" type="text" class="mt-1 w-full" require autocomplete="form.name"/>
                ...
                <div class="col-span-12">
                    ...
                    <x-input id="form.email" wire:model="form.email" type="text" class="mt-1 w-full" require autocomplete="form.email"/>
                ...
                <div class="col-span-12">
                    ...
                    <x-input id="form.address" wire:model="form.address" type="text" class="mt-1 w-full" require autocomplete="form.address"/>
